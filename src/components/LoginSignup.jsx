...
const LoginSignup = () => {
    ...
    const { setIsLogin, isSignUp, setIsSignUp, handleLoginSignup, inputData, setInputData } = useContext(authContext);
            ...
            <div className="relative p-4 text-black w-full max-w-md h-full md:h-auto">
                <div className="relative bg-white rounded-lg shadow">
                    ...
                    <div className="p-5 pt-10">
                        ...
                        {/* for input form */}
                        <form className="w-full" onSubmit={handleLoginSignup}>
                            {isSignUp && (
                                <div>
                        ...
                        <div className="mt-1 text-center text-sm text-slate-600">
                            <p>SignUp or Login as 
                                <span onClick={()=>window.location.href =import.meta.env.VITE_USER_URL} className="text-blue-500 cursor-pointer underline"> User</span>
                            </p>
                        </div>
                    </div>
                </div>
